...
# to f wyżej, to string interpolation, czyli tworzenie stringu, a w takim nawiasie oznacza, że zostanie wyświetlone. Bez tego nawiasu nie

def add_expense(month):
    print()
    expense_amount = int(input("Podaj kwotę wydatku [zł]: "))
    expense_type = input("Podaj typ wyadtku (jedzenie, rozrywka, dom, inny): ")
...
def show_stats(month):
    ...
    total_amount_all = sum(expense_amount for expense_amount, _, expense_month in expenses)
